...
function ALM.InitAM(settingsHandler, displayName, author, version)
    ...
    local optionsTable = {
        ...
        },
        {
            type = "checkbox",
            name = "Debug Mode [WIP]",
            tooltip = "Enable debug mode for detailed logging. WIP",
        ...
        {
            type = "checkbox",
            name = "Log Dungeons [WIP]",
            tooltip = "Enable logging for Dungeons. WIP",
        ...
        {
            type = "checkbox",
            name = "Log World Events [WIP]",
            tooltip = "Enable logging for World Events. WIP",
